export const translations = {
	...
	MANUAL_INSTALLATION_DISCLAIMER: {
		DISCLAIMER:
			"By accepting the following terms, you hereby assume the risk associated with downloading files and installing said files from a direct URL link. The aforementioned links have neither been tested nor approved by Qredit.io.\n\nWe make no warranties, expressed or implied, as to the sustainability, availability, security, of these URLs. We are not responsible for any consequences which may occur from downloading, viewing, or installing files directly from a URL. Qredit.io shall bear no liability for any loss suffered by users as a result of clicking an unverified direct URL.\n\nYou acknowledge that clicking unverified URLs may result in you downloading, viewing, or installing content that may have bugs, glitches, lack of functionality, or can cause damage to your machine or result in the loss of data.",
		TITLE: "Disclaimer",
	},
	MINIMUM_VERSION_NOT_SATISFIED:
		"In order to update this plugin please update the Qredit Wallet to v{{minimumVersion}}+",
	...
	MODAL_UPDATES_CONFIRMATION: {
		...
		DESCRIPTION_INCOMPATIBLE:
			"Some of the plugins cannot be updated as they require a newer version of the Qredit Wallet. Pressing Continue will install all compatible updates.",
	...
	PERMISSIONS: {
		// Legacy permissions
		ALERTS: "Allows access to the Qredit Wallet alerts",
		AUDIO: "Allows access to play audio from within the Qredit Wallet",
		AVATARS: "Plugin contains custom avatars",
		COMPONENTS: "Allows loading custom components",
		DIALOGS: "Allows using file dialogs",
		EVENTS: "Allows access to the Qredit Wallet events",
		FILESYSTEM: "Allows using file dialogs",
		HTTP: "Allows performing external web requests",
		LANGUAGES: "Allows loading additional languages for the Qredit Wallet",
		LAUNCH: "Allows to register a custom view",
		MENU_ITEMS: "Allows adding custom menu items to the Qredit Wallet sidebar",
		...
		ROUTES: "Allows loading additional routes into the Qredit Wallet",
		STORAGE: "Allows storing data within the Qredit Wallet, using key-value pairs",
		STORE: "Allows storing data within the Qredit Wallet, using key-value pairs",
		THEME: "Allows loading additional custom themes for the Qredit Wallet",
		THEMES: "Allows loading additional custom themes for the Qredit Wallet",
		TIMERS: "Allows using timeouts and intervals",
		UI_COMPONENTS: "Allows access to the standard Qredit Wallet components used throughout",
	...
	PLUGIN_INFO: {
		ABOUT: "About",
		DISCLAIMER:
			"The availability of this Plugin in the Qredit Wallet does not mean that Qredit.io is directly involved in its development or developers. By installing it, you assume any associated risks.",
		NOT_ENABLED: "This Plugin is not enabled",
		NOT_LAUNCHEABLE: "This Plugin cannot be launched",
		REPORT: "Report Plugin",
		REQUIREMENTS: "Requirements",
		SCREENSHOTS: "Screenshots",
		WALLET_VERSION: "Qredit Wallet Version v{{minimumVersion}}+",
	},
	...
	UPDATE_ALL_NOTICE_INCOMPATIBLE_one:
		"There is {{count}} update available for your plugins, but your wallet version is incompatible. Please update the Qredit Wallet to continue.",
	UPDATE_ALL_NOTICE_INCOMPATIBLE_other:
		"There are {{count}} updates available for your plugins, but your wallet version is incompatible. Please update the Qredit Wallet to continue.",
