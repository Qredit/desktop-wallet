export const translations = {
	...
	PASSWORD: {
		...
		REMOVAL: {
			DESCRIPTION:
				"Removing your profile password will result in anyone with access to your Qredit Wallet to see all your profile data. Are you sure you wish to remove it?",
