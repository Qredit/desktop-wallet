export const translations = {
	...
	MODAL_WELCOME: {
		...
		STEP_1_DESCRIPTION:
			"Start a quick tour to learn how to get the most out of the Qredit Wallet, or skip it to go directly to your profile.",
		STEP_1_TITLE: "Welcome to Qredit Wallet",
		STEP_2_DESCRIPTION:
		...
		STEP_3_DESCRIPTION:
			"Qredit lets you extend your wallet’s functionality with a growing collection of Games, Utilities and more.",
		STEP_3_TITLE: "Enhance Your Experience With Plugins",
		STEP_4_DESCRIPTION:
			"With Qredit, you’re in control. Swap assets effortlessly without ever leaving your wallet.",
