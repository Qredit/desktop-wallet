export const translations = {
	...
	PAGE_CREATE_WALLET: {
		NETWORK_STEP: {
			GENERATION_ERROR:
				"This network (mainnet) is not available yet. If you want to connect to the Qredit Development Networks, please head over to settings and enable development networks.",
		...
		PASSPHRASE_STEP: {
			...
			WARNING:
				"You are responsible for storing and protecting this mnemonic passphrase offline. The Qredit Wallet cannot reveal this to you at a later time. If you lose this mnemonic passphrase, you will lose your funds.",
		},
